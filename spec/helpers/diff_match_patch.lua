...
* Adapted to Lua 5.4 and cleaned up a little by R. N. West.
*
...
local _diff_compute, _diff_bisect, _diff_halfMatchI, _diff_halfMatch, _diff_cleanupSemanticScore
local _diff_cleanupSemanticLossless, _diff_cleanupMerge, _diff_commonPrefix, _diff_commonSuffix, _diff_commonOverlap
local _diff_xIndex, _diff_text1, _diff_text2, _diff_toDelta, _diff_fromDelta
   ...
   while diffs[pointer] do
      ...
      elseif diff_type == DIFF_EQUAL then
         ...
         if count_delete + count_insert > 1 then
            ...
            for _ = 1, count_delete + count_insert do
      ...
      if start_loc == -1 then
         ...
         if text1 == text2 then
            ...
            if (#text1 > Match_MaxBits) and (diff_levenshtein(diffs) / #text1 > Patch_DeleteThreshold) then
               ...
               local index1 = 1
               local index2
               for _, mod in ipairs(patch.diffs) do
